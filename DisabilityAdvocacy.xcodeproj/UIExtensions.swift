...
extension View {
    ...
    func secondaryBody() -> some View {
        self.font(.subheadline).foregroundStyle(.secondaryText)
    }
    
    func captionText() -> some View {
        self.font(.caption).foregroundStyle(.secondaryText)
    }
    
    func emphasizedCaption() -> some View {
        self.font(.caption.weight(.semibold)).foregroundStyle(.secondaryText)
    }
}
